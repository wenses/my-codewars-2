    ...
    def format_output(el):
        if type(el) != list:
            ...
            if el[1]==0 and el[2]==0:
                es = f'{f"{el[0]} hours" if el[0] > 1 else f"{el[0]} hour"}'
        elif len(el) == 4:
            ...
            if el[1]==0 and el[2]==0 and el[3]==0:
                es = f'{f"{el[0]} days" if el[0] > 1 else f"{el[0]} day"}'

        elif len(el) == 5:
            if el[0] != 0 and el[1] != 0 and el[2] != 0 and el[3] != 0 and el[4] != 0:
            ...
            if el[4] == 0:
                es = f'{f"{el[0]} years" if el[0] > 1 else f"{el[0]} year"}, {f"{el[1]} days" if el[1] > 1 else f"{el[1]} day"}, {f"{el[2]} hours" if el[2] > 1 else f"{el[2]} hour"} and {f"{el[3]} minutes" if el[3] > 1 else f"{el[3]} minute"}'
            if el[1]==0 and el[2]==0 and el[3]==0 and el[4]==0:
                es = f'{f"{el[0]} years" if el[0] > 1 else f"{el[0]} year"}'
        return es
